...
const Main1 = () => {
  return (
    <main className=' sm:flex sm:items-center sm:justify-center sm:flex-row   sm:w-full sm:py-20 w-96 h- flex flex-col pb-80 gap-90  sm:gap-15 md:w-5xl xl:w-12/12 xl:gap-28 '>
        <div className=" leading-18   sm:w-100 h-10 text-center pt-15 px-2 md:pb-60 ">
            ...
            <h1 class="font-bold "><span class="text-orange-600 text-4xl" >SUMMER </span>SPECIAL COLLECTION</h1>
